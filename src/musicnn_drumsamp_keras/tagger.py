...
from musicnn_drumsamp_keras.extractor import extractor


def top_tags(file_name, model='DRUMSAMP_MTT_musicnn', topN=3, input_length=3, input_overlap=False, print_tags=True, save_tags=False):
    ...
    filtered_likelihood_mean = [el for el in tags_likelihood_mean if el>0.9]
