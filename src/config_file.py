DATA_FOLDER =  '/workspaces/classification/data/' # set your data folder

config_preprocess = {
    'drumsamp_spec': {
        'identifier': 'drumsamp',                      # name for easy identification
        'audio_folder': '/workspaces/classification/DRUMSAMP/', # end it with / -> this is an absolute path!
        ...
        'index_file': 'index/index_DRUMSAMP.tsv',  # list of audio representations to be computed
    },
    'msd_spec': {
